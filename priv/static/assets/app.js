...
`, template.innerHTML.trim());
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const sendMessage = () => {
      ...
      if (content) {
        channel.push("new_message", { content }).receive("error", (err) => {
